import { hasEqualSumOfGroupsAndCouponLength, validateFormatRuleObject, validateFormatRuleString } from '../../../src/validators/formatter-validator';

describe('Testing formatter validator', () => {
  ...
  describe('Testing format rule of string type - validateFormatRuleString', () => {
